...
1. Fetch PR metadata (ONLY description, CI status and existing reviews).
...
3. List all files in the `lenses/` directory next to this skill. Spawn one subagent per lens file
...
4. Collect findings. Each finding has a priority (P0–P3) defined in `PRIORITIES.md`. Apply these
...
5. **Present an overview** to the user. Assume they haven't looked at the PR yet. Include:
...
6. **Discuss interactively.** Let the user drive by asking about specific findings or areas. Keep
