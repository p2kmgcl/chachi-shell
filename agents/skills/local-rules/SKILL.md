---
name: local-rules
description: Load machine-local rule overrides for a given skill from the shared agent skills directory.
---
...
2. Locate the shared skills root at `$CHACHI_PATH/agents/skills`.
3. Check if `<skills-root>/<skill-name>/SKILL.local.md` exists.
